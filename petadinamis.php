...
<title>Warung Online Mobile Map GPS</title>
...
<script type="text/javascript">
	...
	//Mengambil data dari database dan melakukan looping untuk menampilkan marker sesuai kordinat pada database
			$sql="SELECT * FROM member, produk WHERE member.`id_member`=produk.`id_member` 
		...
		?>
			...
			var infowindow= new google.maps.InfoWindow({
				content:"<img src='<?php echo $data['gambar']; ?>' width='100' align='left' /><b><?php echo $data['username']; ?></b><br/><?php echo $data['telp']; ?>",
