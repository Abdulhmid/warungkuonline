		...
		<div class="row-fluid">
			<div id="breadcrumb-container" class="view-search-bread span12">
				<ul class="search-cat-box breadcrumb sf-menu"  itemprop="breadcrumb">
					...
					echo "<li class=active><h2>$c[nama_kategori]</h2></li>";
				?>
...
AND produk.`username`=member.`username` AND kategori.id_kategori='$_GET[id]' ORDER BY id_produk DESC LIMIT $posisi,$batas");				 
                            			...
                            			<div class=row-fluid itemprop=offers itemscope itemtype=http://schema.org/Offer>
                            				<div>
                            					<span itemprop=price class=price>Rp. $c[harga]</span>
													...
													if(($c['premium']=='YA')&&($c['keterangan']=='jual')){
													echo"<img itemprop=image src=img/gold_icon.png width='24'>";
													}
													elseif(($c['premium']=='YA')&&($c['keterangan']=='SOLD')){
														echo"<img itemprop=image src=img/sold-out.png width='24'>";
													}
