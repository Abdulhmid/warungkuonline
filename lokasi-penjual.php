...
<script type="text/javascript">
	...
	//Mengambil data dari database dan melakukan looping untuk menampilkan marker sesuai kordinat pada database
			$sql="select * from supir order by nama_supir";
		...
		?>
			...
			var infowindow= new google.maps.InfoWindow({
				content:"<img src=foto_supir/<?php echo $data['tersedia']; ?> width='100' align='left' /><?php echo $data['telp']; ?>",
...
<body onLoad="initialize()">
    ...
    <select id="cari" name="cari">
       <?php
			...
			while($data=mysql_fetch_array($query)){
	  ?>
      		   <option value="<?php echo $n; ?>"><?php echo $data['nama_supir']; ?></option>
       <?php
	   		$n++;
			}
	   ?>
