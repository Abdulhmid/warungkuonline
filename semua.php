			...
			<div class="span12 main-content">
				<div id="content-directory">
					<div class="grid-shop-product" itemscope itemtype="http://schema.org/ItemList">
						...
						$sql = mysql_query("SELECT * FROM produk, kategori, member, kota WHERE produk.`id_kategori`=kategori.`id_kategori` AND produk.`id_kota`=kota.`id_kota`
AND produk.`id_member`=member.`id_member` ORDER BY id_produk DESC LIMIT $posisi,$batas");				 
