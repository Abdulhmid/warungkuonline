...
if (!file_exists($pathfile)){
  ...
  $aksi="modul/mod_tambahadmin/aksi_tambahadmin.php";
switch($_GET[act]){
  // Tampil User
  default:
    ...
    if ($_SESSION[leveluser]=='admin'){
      $tampil = mysql_query("SELECT * FROM manajer ORDER BY username");
      ...
      $tampil=mysql_query("SELECT * FROM manajer 
    ...
    echo "<div id=bluebox>
          ...
          <tr><th>no</th><th>username</th><th>nama lengkap</th><th>email</th><th>No.Telp/HP</th><th>Status</th><th>Blokir</th><th colspan=2>aksi</th></tr>"; 
    $no=1;
